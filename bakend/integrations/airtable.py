...
CLIENT_ID = '10af1298-73ee-438d-ac4a-220216290627'
#CLIENT_SECRET = 'e59aec7edddef2edf4388ef611b151ab5fc85c61f828df909c147085e8ffb4f1'
CLIENT_SECRET = '76a3183d11fc0c685f4af60a72b4cdce9abf908c28f1b963448ac6ac7aa2bd00'
...
async def oauth2callback_airtable(request: Request):
    ...
    print("In oauth2callback"+str(code))
